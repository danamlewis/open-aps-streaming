...
ALTER DEFAULT PRIVILEGES FOR USER :register_user IN SCHEMA register grant SELECT ON tables TO :nightscout_user;
ALTER DEFAULT PRIVILEGES FOR USER :register_user IN SCHEMA register grant SELECT ON sequences TO :nightscout_user;
